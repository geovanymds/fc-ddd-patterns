...
describe("Order repository test", () => {
  ...
  it("should update an order", async () => {
    ...
    const updatedOrderItem2 = new OrderItem(
      "2",
      product2.name,
      product2.price,
      product2.id,
    ...
    const updatedOrder2 = new Order("123", "123", [updatedOrderItem, updatedOrderItem2]);
    await orderRepository.update(updatedOrder2);
